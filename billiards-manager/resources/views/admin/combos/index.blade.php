...
<div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
        <div class="bg-white rounded-lg p-5 border-l-4 border-blue-500 shadow-sm hover:shadow transition">
            <div class="flex items-center justify-between">
                <div>
        ...
        <div class="bg-white rounded-lg p-5 border-l-4 border-green-500 shadow-sm hover:shadow transition">
            <div class="flex items-center justify-between">
                <div>
        ...
        <div class="bg-white rounded-lg p-5 border-l-4 border-red-500 shadow-sm hover:shadow transition">
            <div class="flex items-center justify-between">
                <div>
        ...
        <div class="bg-white rounded-lg p-5 border-l-4 border-purple-500 shadow-sm hover:shadow transition">
            <div class="flex items-center justify-between">
                <div>
            ...
            <div class="overflow-x-auto">
                <table class="w-full">
                    <thead class="bg-gray-50 border-b border-gray-200">
                        <tr>
                            <th class="px-6 py-3 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">Combo</th>
                            <th class="px-6 py-3 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">Loại</th>
                            <th class="px-6 py-3 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">Sản phẩm</th>
                            <th class="px-6 py-3 text-right text-xs font-semibold text-gray-700 uppercase tracking-wider">Giá bán</th>
                            <th class="px-6 py-3 text-right text-xs font-semibold text-gray-700 uppercase tracking-wider">Tiết kiệm</th>
                            ...
                            <tr class="hover:bg-gray-50 transition">
                                <td class="px-6 py-4">
                                    <div>
                                        ...
                                        <p class="text-xs text-gray-500 font-mono mt-0.5">{{ $combo->combo_code }}</p>
                                    </div>
                                </td>
                                <td class="px-6 py-4">
                                    @if ($combo->is_time_combo)
                                        <div>
                                            ...
                                            <p class="text-xs text-gray-600 mt-1">{{ $combo->play_duration_minutes }}p</p>
                                        </div>
                                    @else
                                ...
                                <td class="px-6 py-4">
                                    <span class="text-sm text-gray-900 font-medium">{{ $combo->comboItems->count() }} món</span>
                                </td>
                                <td class="px-6 py-4 text-right">
                                    <div class="text-base font-bold text-gray-900">{{ number_format($combo->price) }}đ</div>
                                    <div class="text-xs text-gray-500 line-through">{{ number_format($combo->actual_value) }}đ</div>
                                </td>
                                <td class="px-6 py-4 text-right">
                                    @if($combo->getDiscountAmount() > 0)
                                        <div class="text-sm font-semibold text-green-600">{{ number_format($combo->getDiscountAmount()) }}đ</div>
                                ...
                                <td class="px-6 py-4 text-center">
                                    <span class="inline-flex items-center">
                                        ...
                                        <span class="text-sm font-medium {{ $combo->status == 'active' ? 'text-green-700' : 'text-red-700' }}">
