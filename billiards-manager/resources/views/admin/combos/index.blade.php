                            ...
                            @foreach ($combos as $combo)
                                <tr class="hover:bg-gray-50 transition">
                                    ...
                                    <td class="px-6 py-4">
                                        @if ($combo->is_time_combo)
                                            <div>
                                                ...
                                                <p class="text-xs text-gray-600 mt-1">{{ $combo->play_duration_minutes }}p
                                                </p>
                                            </div>
                                        @else
                                            <span
                                    ...
                                    <td class="px-6 py-4 text-right">
                                        <div class="text-base font-bold text-gray-900">{{ number_format($combo->price) }}đ
                                        </div>
                                    ...
                                    <td class="px-6 py-4 text-right">
                                        @if ($combo->getDiscountAmount() > 0)
                                            ...
                                            <div class="text-xs text-green-600">({{ $combo->getDiscountPercent() }}%)
                                            </div>
                                        @else
