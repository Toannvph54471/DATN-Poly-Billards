...
@section('title', 'Chỉnh Sửa Danh Mục - F&B Management')
        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between">
            <div class="flex items-center space-x-4">
                ...
                <div>
                    ...
                    <p class="text-gray-600 mt-2">Chỉnh sửa danh mục đã chọn</p>
                </div>
            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select name="type" id="type" required=""
                            ...
                            <option value="table" {{ $category->type == 'table' ? 'selected' : '' }}>Table</option>
                    ...
                    <div>
                        ...
                        <input type="number" name="hourly_rate" id="hourly_rate" value="{{ $category->hourly_rate }}"
                            required="" min="0"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
                            placeholder="50000">
                    </div>
                    ...
                    <div>
                        ...
                        <select name="status" id="status" required=""
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">
                            <option value="active" {{ $category->status == 'active' ? 'selected' : '' }}>Đang kích hoạt
                            </option>
                            <option value="inactive" {{ $category->status == 'inactive' ? 'selected' : '' }}>Ngừng kích hoạt
                            </option>
                        </select>
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="description" id="description" rows="3"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
                            placeholder="Mô tả chi tiết danh mục...">{{ $category->description }}</textarea>
                    </div>
                </div>
