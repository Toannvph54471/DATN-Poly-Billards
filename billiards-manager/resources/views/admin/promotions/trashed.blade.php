...
@section('title', 'Khuyến mại đã xóa')

@section('content')
    <div class="flex justify-between items-center mb-4">
        <h1 class="text-2xl font-bold text-gray-800">Khuyến mại đã xóa</h1>
    ...
    <table class="min-w-full bg-white border border-gray-200 rounded-lg shadow-md overflow-hidden">
        <thead class="bg-gray-100">
            <tr>
                ...
                <th class="py-3 px-6 text-left">Khuyến mại</th>
                <th class="py-3 px-6 text-left">Giá trị giảm</th>
        ...
        <tbody>
            @forelse ($promotions as $promotion)
                <tr class="border-b hover:bg-gray-50">
                    ...
                    <td class="py-4 px-6 font-medium text-gray-800">{{ $promotion->name }}</td>
                    <td class="py-4 px-6 text-gray-700">{{ number_format($promotion->discount_value, 0, ',', '.') }}₫</td>
                    <td class="py-4 px-6">
            ...
            @empty
                <tr>
                    <td colspan="4" class="py-4 px-6 text-center text-gray-500">Không có khuyến mại nào bị xóa.</td>
                </tr>
            @endforelse
        </tbody>
    </table>
