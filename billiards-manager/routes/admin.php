...
Route::prefix('admin')
    ...
    ->group(function () {
        ...
        Route::prefix('bills')->name('bills.')->group(function () {
            ...
            Route::get('/bills/{id}/print', [BillController::class, 'printBill'])->name('print');
            ...
            Route::get('/bills/transfer/{billId}', [BillController::class, 'showTransferForm'])->name('transfer-form');
