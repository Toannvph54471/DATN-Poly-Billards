...
|--------------------------------------------------------------------------
| Chỉ Admin + Manager được vào trang /admin
| Worker/Employee sẽ KHÔNG TRUY CẬP file này.
|--------------------------------------------------------------------------
*/
...
Route::prefix('admin')
    ...
    ->group(function () {
        ...
        */
        ...
        | ADMIN + MANAGER
        |--------------------------------------------------------------------------
        | Đây là phần management, employee không thấy ở file này.
        */
        ...
        Route::get('tables/{id}/detail', [TableController::class, 'showDetail'])
            ->name('tables.detail');
        ...
        Route::prefix('bills')->name('bills.')->group(function () {
            ...
            Route::post('{bill}/stop-combo', [BillController::class, 'stopComboTime'])->name('stop-combo');

            Route::delete('/bills/{bill}/products/{billDetail}', [BillController::class, 'removeProductFromBill'])->name('remove-product');
            Route::post('/bills/transfer', [BillController::class, 'transferTable'])->name('transfer');
            Route::get('/bills/transfer/available/{billId}', [BillController::class, 'getAvailableTables'])->name('transfer.available');
        });
