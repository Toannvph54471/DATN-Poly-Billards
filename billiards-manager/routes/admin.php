    ...
    ->group(function () {
        ...
        Route::middleware(['role:admin,manager'])->group(function () {
            ...
            Route::prefix('combos')->name('combos.')->group(function () {
                ...
                // API Helpers
                Route::get('/api/rates-by-category', [ComboController::class, 'getTableRatesByCategory'])->name('rates-by-category');
                Route::post('/api/preview-price', [ComboController::class, 'previewComboPrice'])->name('preview-price');
                Route::get('/api/calculate-table-price', [ComboController::class, 'calculateTablePriceAPI'])->name('calculate-table-price');
            });
            ...
            Route::prefix('bills')->name('bills.')->group(function () {
                ...
                Route::delete('/{id}/remove-product/{detailId}', [BillController::class, 'removeProductFromBill'])->name('remove-product');
        ...
        Route::middleware(['role:admin,manager,employee'])->group(function () {
            ...
            Route::get('/attendance/server-time', [AttendanceController::class, 'getServerTime'])->name('attendance.server-time');
        });
    });
